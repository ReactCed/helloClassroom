...
const initialState : studManageAccState = {
    file: null,
    imageUrl: '',
...
const studManageAccSlice = createSlice({
    name: 'studManageAcc',
    initialState,
    reducers: {
...
export const {setFile, setImageUrl, setShowUpdateNameModal, setShowUpdateEmailModal, setShowUpdateAddressModal, setClassUsersImage, setClassUsersName, setClassUsersEmail, setClassUsersAddress, setClassUsersRole} = studManageAccSlice.actions;

export default studManageAccSlice.reducer;